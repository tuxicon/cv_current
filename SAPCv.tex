...
\address{Zi 30.13.10 Franz-Mehring-Platz 3}{10243 Berlin, Germany}    % optional, remove / comment the line if not wanted
\mobile{+4915166182128}                     % optional, remove / comment the line if not wanted
...
\cvitem{Summary} {I'm excited to be a part of ventures that lead to building interactive systems using the existing the interaction contexts in real world and deep understanding of users} 
